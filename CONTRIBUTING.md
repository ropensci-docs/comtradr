...
This outlines how to propose a change to comtradr. For more detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("ropensci/comtradr", fork = TRUE)`.
...
Please note that the comtradr project is released with a [Contributor
Code of Conduct](https://docs.ropensci.org/comtradr/CODE_OF_CONDUCT.md).
